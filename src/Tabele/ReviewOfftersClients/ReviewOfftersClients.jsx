...
import DetailClientOffers from 'Modal/DetailClientOffers/DetailClientOffers';
  ...
  return (
    <div>
      ...
      <Modal
        ...
        footer={null}
      >
        <Clients preview propsklijenta={selectedBuyer} closeModal={() => setIsClientVisible(false)} />
      </Modal>
