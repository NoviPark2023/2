...
function ReviewLocal() {
    ...
    return (
        <div>
            ...
            <Table columns={columns} dataSource={data} pagination={false} scroll={{y: 'calc(100vh - 265px)'}}
                   rowKey="id_lokala"/>
            <Modal title="Izmeni podatke lokala" visible={editLocal} onOk={handleOk} onCancel={handleCancel}
                   footer={null}>
