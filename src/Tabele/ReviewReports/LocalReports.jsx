...
import lokali_izvestaji_icon from '../../assets/local/local-reports.png';
    ...
    <Scroll>
      ...
      <Row>
        <Col span={24}>
          <Title level={3}>
            {' '}
            <img src={lokali_izvestaji_icon} alt="icon lokali" />
            Izveštaji Lokali
          </Title>
          <Divider />
        </Col>
            ...
            >
              ...
              >
                ...
                <Title level={5} align="center">
                  Broj prodatih lokala po mesecima
                </Title>
            ...
            <Col span={24}>
              ...
              >
                <PieChart width={400} height={400}>
                  <Pie data={data_lokali_procenti} dataKey="value" fill="#8884d8" label>
