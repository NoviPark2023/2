  ...
  return (
    <div>
      ...
      <Modal title="Izmeni podatke lokala" visible={editLocal} onOk={handleOk} onCancel={handleCancel} footer={null}>
        <Local edit propslokala={selectedLocal} getData={getData} closeModal={() => showModal(false)} />
      </Modal>
      <Modal
        destroyOnClose={true}
        ...
        footer={null}
      >
        <Local propslokala={selectedLocal} getData={getData} closeModal={() => setCreateLocal(false)} />
      </Modal>
